...
from help_option import get_help
...
{red}[{end}a{red}]{end} About      {red}[{end}h{red}]{end} Help      {red}[{end}s{red}]{end} Settings      {red}[{end}0{red}]{end} Exit''')        
...
# Choix autres : 'a' (Affichage des informations du programme)
        elif choix.lower() == 'a' or choix.lower() == 'aa':
            os.system('cls')
            about()
            print()
            restart()
...
# Choix autres : 'h' (Affichage d'aide sur les options)
        elif choix.lower() == 'h' or choix.lower() == 'hh':
            os.system('cls')
            get_help()
            print()
            
# Choix autres : 's' (Affichage des paramètres)
        elif choix.lower() == 's' or choix.lower() == 'ss':
            os.system('cls')
            manage_settings()
            print()

# Choix numéro 0 (Fermeture du programme)
        elif choix == '0' or choix == '00':
            os.system('cls')
            sys.exit(1)
